...
class TripPresenter {
  ...
  init() {
    ...
    if (points.length === 0) {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_4__.render)(new _view_no_points_view_js__WEBPACK_IMPORTED_MODULE_5__["default"](), this.#tripComponent.element, _framework_render_js__WEBPACK_IMPORTED_MODULE_4__.RenderPosition.AFTERBEGIN);
      return;
    }
