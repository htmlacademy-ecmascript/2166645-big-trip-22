...
class TripPresenter {
  ...
  init() {
    ...
    if (Array.from(this.#pointsList).length === 0) {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_4__.render)(new _view_no_points_view_js__WEBPACK_IMPORTED_MODULE_5__["default"](), this.#tripComponent.element);
      return;
    }
...
class NewFormView extends _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
function createNoPointsTemplate() {
  return `
  <p class="trip-events__msg">${_const_js__WEBPACK_IMPORTED_MODULE_1__.FILTERS.EVERYTHING}</p>
  `;
}
...
(0,_framework_render_js__WEBPACK_IMPORTED_MODULE_5__.render)(new _view_filters_view_js__WEBPACK_IMPORTED_MODULE_1__["default"](), tripControlsFiltersElement);
...
/******/ })()
;
//# sourceMappingURL=bundle.8b395e5b9bf6e640ba21.js.map